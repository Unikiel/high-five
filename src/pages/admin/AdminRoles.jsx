...
const DEFAULT_MATRIX = {
  ...
  tutor:     { dashboard: true, courses: true, practice: true, progress: true, tutoring: true, settings: true, admin: true, admin_students: false, admin_courses: false, admin_reports: true, admin_sessions: true, admin_billing: false, admin_roles: false },
