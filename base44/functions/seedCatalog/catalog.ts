...
// Ported verbatim from src/lib/courseData.js, which is deleted once the
// database becomes the single source of truth for the catalog. Unit numbers
// are per-course and deliberately not contiguous across courses.
export const CATALOG: CatalogCourse[] = [
    ...
    units: [
      ...
      },
      {
        ...
        topics: [
          ...
          'Selecting Procedures for Differentiation',
      ...
      },
      {
        ...
        topics: [
          ...
          'Extreme Value Theorem, Global Extrema, and Local Extrema',
      ...
      },
      {
        ...
        topics: [
          ...
          'Euler\'s Method',
          'General Solutions Using Separation of Variables',
      ...
      },
      {
        ...
        topics: [
          ...
          'Volumes with the Disc Method',
          'Volumes with the Washer Method',
        ],
      },
    ],
  },
  {
    ...
    icon: 'BC',
    description:
      'AP Calculus AB topics plus parametric, polar, vector-valued functions, and infinite series.',
    order: 2,
    units: [
      {
        number: 1,
      ...
      },
      {
        ...
        topics: [
          ...
          'Finding Arc Lengths of Polar Curves',
        ],
      },
      {
        number: 10,
  ...
  },
  {
    ...
    icon: 'P1',
    description:
      'Algebra-based mechanics with fluids included in the current AP Physics 1 framework.',
    order: 3,
    units: [
      {
        number: 1,
      ...
      },
      {
        ...
        topics: [
          ...
          'Frequency and Period of Simple Harmonic Oscillators',
  ...
  },
  {
    ...
    icon: 'P2',
    description:
      'Algebra-based thermodynamics, electricity and magnetism, optics, waves, and modern physics.',
    order: 4,
    units: [
      {
        number: 9,
        ...
        weight: '15-20%',
        topics: [
          'Thermal Systems and State Variables',
          'Pressure, Thermal Equilibrium, and Temperature',
          'Ideal Gas Law',
          'Kinetic Molecular Theory',
          'Internal Energy',
          'Energy Transfer and Thermal Processes',
      ...
      },
      {
        ...
        topics: [
          ...
          'Fields and Potentials of Charge Distributions',
        ],
      },
      {
        number: 11,
      ...
      },
      {
        ...
        topics: [
          ...
          'Images from Mirrors',
          'Images from Lenses',
          'Ray Diagrams and Optical Instruments',
        ],
      },
      {
        number: 14,
  ...
  },
  {
    ...
    icon: 'CM',
    description:
      'Calculus-based mechanics aligned to the current AP Physics C: Mechanics framework.',
    order: 5,
    units: [
      {
        number: 1,
  ...
  },
  {
    ...
    icon: 'EM',
    description:
      'Calculus-based electricity and magnetism aligned to the current AP Physics C: E&M framework.',
    order: 6,
    units: [
      {
        number: 8,
  ...
  },
  {
    ...
    icon: 'CP',
    description:
      'Creative development, data, algorithms, programming, computer systems, networks, and impacts of computing.',
    order: 7,
    units: [
      {
        number: 1,
  ...
  },
  {
    ...
    icon: 'CA',
    description:
      'Java programming using objects, methods, control structures, classes, and data collections.',
    order: 8,
    units: [
      {
        number: 1,
        ...
        topics: [
          ...
          'Math Class Methods',
          'Wrapper Classes',
          'Documentation and Preconditions',
        ],
      },
      {
        number: 2,
        ...
        topics: [
          ...
          'for Loops',
          'Nested Iteration',
          'Tracing and Debugging Control Structures',
        ],
      },
      {
        number: 3,
  ...
  },
  {
    ...
    icon: 'ST',
    description:
      'Exploring data, collecting data, probability, sampling distributions, and statistical inference.',
    order: 9,
    units: [
      {
        number: 1,
      ...
      },
      {
        ...
        topics: [
          ...
          'Justifying a Claim Based on a Confidence Interval for a Difference of Two Proportions',
          'Testing for a Difference of Two Population Proportions',
        ],
      },
      {
        number: 7,
        ...
        topics: [
          ...
          'Justifying a Claim Based on a Confidence Interval for a Difference of Two Means',
      ...
      },
      {
        ...
        topics: [
          ...
          'Expected Counts, Conditions, and Contributions',
        ],
      },
      {
        number: 9,
        ...
        weight: '2-5%',
        topics: [
          'Introducing Inference for Slopes',
  ...
  },
  {
    ...
    icon: 'PC',
    description:
      'Polynomial, rational, exponential, logarithmic, trigonometric, polar, parametric, vector, and matrix functions.',
    order: 10,
    units: [
      {
        number: 1,
        ...
        topics: [
          ...
          'Equivalent Representations of Polynomial and Rational Functions',
      ...
      },
      {
        ...
        topics: [
          ...
          'Sine and Cosine Function Equations and Inequalities',
      ...
      },
      {
        ...
        topics: [
          ...
          'Parametric Equations and Implicitly Defined Functions',
          'Vectors',
